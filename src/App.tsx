...
import { Activity, ActivityIcon, ChartColumnIcon, FileTextIcon, TrendingUp, Users2Icon } from 'lucide-react';
              ...
              <CardHeader>
                <CardTitle>
                  <div className='flex gap-3 items-center'>
                    <FileTextIcon />
                    <h2 className="font-bold text-2xl">Archivo cargado</h2>
                  </div>
                </CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col gap-5 md:gap-y-5 md:gap-x-3">
                <h4 className="font-semibold">{fileSelected.name}</h4>
              </CardContent>
            </Card>
          </div>
        )}
