...
const SessionInfo = ({ sections }: {
    ...
    return (
        <header className="flex flex-col gap-5 p-5 border-1 border-neutral-200 rounded-md">
            ...
            <div className="grid grid-cols-[max-content_max-content] md:grid-cols-[max-content_1fr_max-content] max-md:justify-between grid-rows-2 gap-5 md:gap-y-5 md:gap-x-3">
                {sections?.sesion.map(sesion => {
                    const { Id_de_sesion, Nombre, Lugar, Fecha } = sesion;
                    ...
                    return (
                        <>
                            ...
                            <div className="grid grid-cols-[max-content_max-content] md:justify-center gap-3 w-fit">
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <span className="font-bold text-lg">{Lugar}</span>
                                </div>
                            </div>
                            <div className="flex items-center max-md:row-start-2 md:justify-center gap-3">
                                ...
                                <div className='flex flex-col'>
                                    <span className="text-gray-500">ID Sesión</span>
                                    <span className="font-bold text-lg"># {Id_de_sesion}</span>
                                </div>
                            </div>
                            <div className="md:col-span-3 md:row-start-2">
                                <div className='flex flex-col'>
                                    <span className="text-gray-500">Nombre de la sesión</span>
